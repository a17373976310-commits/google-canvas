...
export const NODE_CATALOG: NodeCatalogItem[] = [
    ...
    { type: NodeType.TEXT_RECOGNITION, label: '文字识别', desc: '识别图片文字并输出可编辑图层', keywords: ['文字识别', 'OCR', '图层', 'text', 'ocr'], icon: Type, color: 'text-violet-400' },
    ...
    { type: NodeType.DESIGN_BOARD, label: '设计画板', desc: '可编辑文字与图层', keywords: ['设计', '画板', '文字', '字体', 'ps', 'design'], icon: Palette, color: 'text-violet-400' },
