    ...
    return (
        <BaseNode id={id} data={data} icon={FileSpreadsheet} color="bg-emerald-500" selected={selected}>
            <div className="p-4 space-y-3 flex-1 overflow-hidden">
                <div className={`inline-flex w-fit items-center gap-1 rounded-md border px-2 py-1 text-[9px] font-semibold ${data.inputs?.file || data.inputs?.default ? 'border-fuchsia-500/25 bg-fuchsia-500/10 text-fuchsia-300' : 'theme-border-subtle theme-text-muted'}`}>
                ...
                <div className="rounded-2xl border border-emerald-500/10 bg-emerald-500/[0.04] p-3 space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        <label className="space-y-1">
                            <span className="text-[8px] font-black theme-text-muted uppercase tracking-widest">工作表</span>
                            <input
                                className="w-full theme-bg-input border theme-border-medium rounded-xl px-3 py-2 text-[11px] theme-text-primary focus:outline-none focus:border-emerald-500/50"
                        ...
                        <label className="space-y-1">
                            <span className="text-[8px] font-black theme-text-muted uppercase tracking-widest">解析模式</span>
                            <select
                                className="w-full theme-bg-input border theme-border-medium rounded-xl px-3 py-2 text-[11px] theme-text-primary focus:outline-none focus:border-emerald-500/50"
                                value={parseMode}
                    ...
                    <div className="text-[9px] theme-text-muted leading-relaxed">
                ...
                <div className="grid grid-cols-2 gap-2">
                    <label className="space-y-1">
                        <span className="text-[8px] font-black theme-text-muted uppercase tracking-widest">数据起始行</span>
                        <input
                            type="number"
                            min={1}
                            className="w-full theme-bg-input border theme-border-medium rounded-xl px-3 py-2 text-[11px] theme-text-primary focus:outline-none focus:border-emerald-500/50"
                    ...
                    <label className="space-y-1">
                        <span className="text-[8px] font-black theme-text-muted uppercase tracking-widest">需求列</span>
                        <input
                            className="w-full theme-bg-input border theme-border-medium rounded-xl px-3 py-2 text-[11px] theme-text-primary focus:outline-none focus:border-emerald-500/50 uppercase"
                    ...
                    <label className="space-y-1 col-span-2">
                        <span className="text-[8px] font-black theme-text-muted uppercase tracking-widest">文案列</span>
                        <input
                            className="w-full theme-bg-input border theme-border-medium rounded-xl px-3 py-2 text-[11px] theme-text-primary focus:outline-none focus:border-emerald-500/50 uppercase"
                ...
                {(parseMode === 'smart' || parseMode === 'auto') && (
                    <div className="rounded-2xl border border-indigo-500/15 bg-indigo-500/[0.05] p-3 space-y-3">
                        ...
                        <div className="rounded-xl border border-white/5 theme-bg-input px-3 py-2">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            <label className="space-y-1">
                                <span className="text-[8px] font-black theme-text-secondary uppercase tracking-widest">每张截图行数</span>
                                <input
                                    type="number"
                                    min={6}
                                    className="w-full theme-bg-input border theme-border-medium rounded-xl px-3 py-2 text-[11px] theme-text-primary focus:outline-none focus:border-indigo-500/50"
                                    value={data.config.smartRowsPerSnapshot ?? 18}
                                    onChange={(e) => setConfig({ smartRowsPerSnapshot: Number(e.target.value || 18) })}
                                />
                            </label>
                            <label className="space-y-1">
                                <span className="text-[8px] font-black theme-text-secondary uppercase tracking-widest">截图最大列数</span>
                                <input
                                    type="number"
                                    min={4}
                                    className="w-full theme-bg-input border theme-border-medium rounded-xl px-3 py-2 text-[11px] theme-text-primary focus:outline-none focus:border-indigo-500/50"
                        ...
                        <label className="space-y-1 block">
                            <span className="text-[8px] font-black theme-text-secondary uppercase tracking-widest">补充说明</span>
                            <textarea
                                className="w-full h-20 resize-none theme-bg-input border theme-border-medium rounded-xl px-3 py-2 text-[11px] theme-text-primary focus:outline-none focus:border-indigo-500/50"
                ...
                <div className="rounded-2xl border border-emerald-500/10 bg-emerald-500/[0.04] p-3 space-y-2">
                    ...
                    {output ? (
                        <div className="grid grid-cols-2 gap-2 text-[10px]">
                            <div className="rounded-xl border border-white/5 theme-bg-input px-3 py-2">
                                <div className="theme-text-muted">工作表</div>
                                <div
                ...
                <div className="rounded-2xl border theme-border-medium theme-bg-input p-3 min-h-[140px] max-h-[320px] overflow-auto">
                                ...
                                <div key={task.taskId} className="rounded-xl border border-white/5 bg-white/[0.02] px-3 py-2">
                                    <div className="flex items-center justify-between gap-2">
                                        <span className="text-[10px] font-black text-white">
                                            第 {previewIndex + 1} 条
                                            <span className="ml-1 theme-text-muted font-semibold">#{task.serialNo || task.rowNumber}</span>
                                        </span>
                                    ...
                                    <div className="mt-1 text-[10px] theme-text-secondary line-clamp-3">
