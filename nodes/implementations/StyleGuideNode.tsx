        ...
        <BaseNode id={id} data={data} icon={Palette} color="bg-violet-500" selected={selected}>
            <div className="p-4 space-y-3 overflow-y-auto">
                <div className="flex flex-wrap gap-1.5">
                    <span className={`inline-flex items-center gap-1 rounded-md border px-2 py-1 text-[9px] font-semibold ${task ? 'border-emerald-500/25 bg-emerald-500/10 text-emerald-300' : 'theme-border-subtle theme-text-muted'}`}>
                        <Rows3 size={10} />
                        任务
                    </span>
                    <span className={`inline-flex items-center gap-1 rounded-md border px-2 py-1 text-[9px] font-semibold ${imageCount > 0 ? 'border-orange-500/25 bg-orange-500/10 text-orange-300' : 'theme-border-subtle theme-text-muted'}`}>
                        <ImageIcon size={10} />
                        参考图 {imageCount || ''}
                    </span>
                </div>
                <div className="grid grid-cols-2 gap-2">
                    <label className="space-y-1">
                        <span className="text-[8px] font-black theme-text-muted uppercase tracking-widest">风格名称</span>
                        <input
                            className="w-full theme-bg-input border theme-border-medium rounded-xl px-3 py-2 text-[11px] theme-text-primary focus:outline-none focus:border-violet-500/50"
                    ...
                    <label className="space-y-1">
                        <span className="text-[8px] font-black theme-text-muted uppercase tracking-widest">整体调性</span>
                        <input
                            className="w-full theme-bg-input border theme-border-medium rounded-xl px-3 py-2 text-[11px] theme-text-primary focus:outline-none focus:border-violet-500/50"
                ...
                <label className="block space-y-1">
                    <span className="text-[8px] font-black theme-text-muted uppercase tracking-widest">配色方案</span>
                    <input
                        className="w-full theme-bg-input border theme-border-medium rounded-xl px-3 py-2 text-[11px] theme-text-primary focus:outline-none focus:border-violet-500/50"
                ...
                <div className="grid grid-cols-2 gap-2">
                    <label className="space-y-1">
                        <span className="text-[8px] font-black theme-text-muted uppercase tracking-widest">光线风格</span>
                        <input
                            className="w-full theme-bg-input border theme-border-medium rounded-xl px-3 py-2 text-[11px] theme-text-primary focus:outline-none focus:border-violet-500/50"
                    ...
                    <label className="space-y-1">
                        <span className="text-[8px] font-black theme-text-muted uppercase tracking-widest">背景环境</span>
                        <input
                            className="w-full theme-bg-input border theme-border-medium rounded-xl px-3 py-2 text-[11px] theme-text-primary focus:outline-none focus:border-violet-500/50"
                ...
                <div className="grid grid-cols-2 gap-2">
                    <label className="space-y-1">
                        <span className="text-[8px] font-black theme-text-muted uppercase tracking-widest">构图规则</span>
                        <input
                            className="w-full theme-bg-input border theme-border-medium rounded-xl px-3 py-2 text-[11px] theme-text-primary focus:outline-none focus:border-violet-500/50"
                    ...
                    <label className="space-y-1">
                        <span className="text-[8px] font-black theme-text-muted uppercase tracking-widest">镜头语言</span>
                        <input
                            className="w-full theme-bg-input border theme-border-medium rounded-xl px-3 py-2 text-[11px] theme-text-primary focus:outline-none focus:border-violet-500/50"
                ...
                <label className="block space-y-1">
                    <span className="text-[8px] font-black theme-text-muted uppercase tracking-widest">材质表现</span>
                    <input
                        className="w-full theme-bg-input border theme-border-medium rounded-xl px-3 py-2 text-[11px] theme-text-primary focus:outline-none focus:border-violet-500/50"
                ...
                <label className="block space-y-1">
                    <span className="text-[8px] font-black theme-text-muted uppercase tracking-widest">质量关键词</span>
                    <textarea
                        className="w-full h-16 resize-none theme-bg-input border theme-border-medium rounded-xl px-3 py-2 text-[11px] theme-text-primary focus:outline-none focus:border-violet-500/50"
                ...
                <label className="block space-y-1">
                    <span className="text-[8px] font-black theme-text-muted uppercase tracking-widest">连贯性规则</span>
                    <textarea
                        className="w-full h-16 resize-none theme-bg-input border theme-border-medium rounded-xl px-3 py-2 text-[11px] theme-text-primary focus:outline-none focus:border-violet-500/50"
                ...
                <label className="block space-y-1">
                    <span className="text-[8px] font-black theme-text-muted uppercase tracking-widest">负面约束</span>
                    <textarea
                        className="w-full h-16 resize-none theme-bg-input border theme-border-medium rounded-xl px-3 py-2 text-[11px] theme-text-primary focus:outline-none focus:border-violet-500/50"
                ...
                <div className="grid grid-cols-2 gap-2">
                    <div className="rounded-2xl border theme-border-medium theme-bg-input p-3">
                        ...
                        {task ? (
                            <div className="space-y-1">
                                ...
                                <div className="text-[10px] theme-text-secondary line-clamp-3">{task.requirementZh || '暂无任务文案'}</div>
                                <div className="text-[9px] text-violet-300">{task.visualSpec?.targetAspectRatio || task.size || '未指定尺寸'}</div>
                            </div>
                        ) : (
                            <div className="text-[10px] theme-text-muted">未连接任务时，将按当前配置输出通用风格约束。</div>
                        )}
                    </div>
                    ...
                    <div className="rounded-2xl border theme-border-medium theme-bg-input p-3">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-[9px] font-black uppercase tracking-widest theme-text-secondary">风格摘要</span>
                        </div>
                        <div className="space-y-1">
                            <div className="text-[10px] text-white font-bold">{data.config.styleName || '未命名风格'}</div>
                            <div className="text-[10px] theme-text-secondary line-clamp-3">{output?.summary || '运行后会输出结构化风格提示词。'}</div>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-2">
                    <div className="rounded-xl border border-violet-500/10 bg-violet-500/[0.03] p-2.5">
                        ...
                        <div className="text-[10px] theme-text-secondary line-clamp-4">
                ...
                {output?.stylePrompt && (
                    <div className="rounded-2xl border border-violet-500/10 bg-violet-500/[0.03] p-3 space-y-2">
                        ...
                        <div className="text-[10px] theme-text-secondary whitespace-pre-wrap leading-relaxed max-h-40 overflow-y-auto">
                            {output.stylePrompt}
                        </div>
                    </div>
                )}
